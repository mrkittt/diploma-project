...
headers = {
    ...
    'Host': kibana_addr,
    'kbn-version': '8.6.2',
    'Authorization': 'Apikey N2hBNFBvZ0JFai04UjItci1RZnA6ZUc3T04zMVlUWjZPUEFuUXpDWUdwUQ==',
    'Connection': 'close'
}

alerts = get_alerts(last_hours=12, size=20)
api = TheHiveApi(thehive_addr, 'XR6ye6d080jOeL10wQSxYP+Bn8LCHmt/')
vt_api = 'c9630c26e7f43b1975be9b3c3ec4d8a37dbc51fa1c4d3b18bad5fd8851c82a53'
...
for alert in alerts.values():
    ...
    try:
        ...
        try:
            ...
            print('Error in Case Observable creation')
            time.sleep(5)
    except CaseException:
        print('Error in Case creation')
        time.sleep(5)
